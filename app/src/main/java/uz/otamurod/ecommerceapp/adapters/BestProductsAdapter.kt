...
import uz.otamurod.ecommerceapp.databinding.ProductRvItemBinding

class BestProductsAdapter : RecyclerView.Adapter<BestProductsAdapter.ViewHolder>() {
    inner class ViewHolder(private val productRvItemBinding: ProductRvItemBinding) :
        RecyclerView.ViewHolder(productRvItemBinding.root) {
        fun onBind(product: Product) {
            productRvItemBinding.apply {
